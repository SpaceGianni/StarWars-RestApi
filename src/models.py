...
#MODELO PARA CREAR, EDITAR Y BORRAR USUARIOS
class User(db.Model):
    __tablename__="users"
...
#MODELO PARA CREAR UN PERSONAJE FAVORITO
...
#MODELO PARA CREAR, EDITAR Y BORRAR UN PLANETA FAVORITO
