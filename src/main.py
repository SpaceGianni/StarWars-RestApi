...
#PERSONAJES
# Lista todos los elementos People de la base de datos
...
# Ruta para traer un solo personaje de la base de datos
@app.route('/people/<int:id>', methods=['GET'])
def traer_personaje(id):
     personaje = People.query.get(id)
     return jsonify(personaje.serialize()), 200

# Ruta para agregar un personaje a la base de datos
...
# Ruta para editar un personaje de la base de datos
...
# Ruta para borrar un personaje de la base de datos
...
#PLANETAS
# Lista todos los elementos Planets de la base de datos
...
# Ruta para traer un solo planeta de la base de datos
@app.route('/planets/<int:id>', methods=['GET'])
def traer_planeta(id):
     planeta = Planets.query.get(id)
     return jsonify(planeta.serialize()), 200

# Ruta para agregar un nuevo planeta a la base de datos
...
#Ruta para eliminar un planeta de la tabla
...
#Trae todos los favoritos del usuario actual
...
#FAVORITOS
##Ruta para añadir un personaje favorito al usuario actual por ID
...
##Ruta para añadir un planeta favorito al usuario actual por ID
...
# Ruta para borrar un personaje favorito
...
##Ruta para borrar un planeta favorito al usuario actual por ID
